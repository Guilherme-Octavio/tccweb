...
<body id="top">
  <header class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-light bg-light" id="header-nav" role="navigation">
      <div class="container"><a class="link-dark navbar-brand site-title mb-0" href="#">LetsConnect</a>
  ...
  <div class="page-content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="mt-5 pt-lg-5">
                  <h1 class="intro-title marker" data-aos="fade-left" data-aos-delay="50">LetsConnect conecta você ao
                    Mundo. </h1>
                  <p class="lead fw-normal mt-4" data-aos="fade-up" data-aos-delay="100">Nós somos uma empresa que prezamos pela experiencia do cliente e pela praticidade que temos
                    em ajudar a sua empresa a ingressar neste mundo virtual. Nós tambem pensamos na experiencia do seu cliente assim deixando sua empresa muito bem vista.
                  </p>
                  <div class="mt-3" data-aos="fade-up" data-aos-delay="200"><a class="btn btn-primary shadow-sm mt-1 me-2" href="#contact">Começe na LetsConnect<i class="fas fa-arrow-right ms-1"></i></a><a class="btn btn-outline-secondary mt-1" data-bigpicture="{&quot;ytSrc&quot;: &quot;aqz-KE-bpKQ&quot;}" href="#"><i class="fas fa-play-circle me-1"></i>Assista nosso video</a></div>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row py-3 py-lg-5">
          ...
          <div class="col-lg-6 col-md-7 px-2" data-aos="zoom-in" data-aos-delay="100">
            <div class="h3 mb-2">Deixe nosso <strong>Equipe Ágil</strong> entender e atender às suas necessidades.</div>
            <div class="row">
              <div class="col-lg-6 mb-2">
                <div class="border border-3 rounded px-2 py-2 d-flex align-items-center">
                  ...
                  <div class="text-secondary fw-bold">Colaboração ativa</div>
                </div>
              </div>
              <div class="col-lg-6 mb-2">
                <div class="border border-3 rounded px-2 py-2 d-flex align-items-center">
                  <div class="badge bg-success me-2"><i class="fas fa-check"></i></div>
                  <div class="text-secondary fw-bold">Entrega dentro do prazo</div>
                </div>
              </div>
              <div class="col-lg-6 mb-2">
                <div class="border border-3 rounded px-2 py-2 d-flex align-items-center">
                  <div class="badge bg-success me-2"><i class="fas fa-check"></i></div>
                  <div class="text-secondary fw-bold">Serviços de pós-venda</div>
                </div>
              </div>
              <div class="col-lg-6 mb-2">
                <div class="border border-3 rounded px-2 py-2 d-flex align-items-center">
                  <div class="badge bg-success me-2"><i class="fas fa-check"></i></div>
                  <div class="text-secondary fw-bold">Suporte 24x7</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row py-3 py-lg-5">
          ...
          <div class="col-lg-6 col-md-7 px-2" data-aos="zoom-in" data-aos-delay="100">
            <div class="h3 mb-2">Nossa<strong>equipe</strong>devolve os melhores resultados</div>
            <div>
              <div class="py-1">
                <div class="d-flex text-small fw-bolder"><span class="me-auto">Desenvolvimento Web</span><span>90%</span></div>
        ...
        <div class="row py-3 py-lg-5">
          ...
          <div class="col-lg-6 col-md-7 px-2" data-aos="zoom-in" data-aos-delay="100">
            <ul class="nav nav-tabs nav-fill" role="tablist">
              <li class="nav-item" role="presentation"><a class="nav-link p-1 active" aria-current="page" href="#experience" data-bs-toggle="tab"><span class="badge bg-secondary me-1">1</span>
                  Missão</a></li>
              <li class="nav-item" role="presentation"><a class="nav-link p-1" href="#flexibility" data-bs-toggle="tab"><span class="badge bg-secondary me-1">2</span> Visão</a></li>
              <li class="nav-item" role="presentation"><a class="nav-link p-1" href="#results" data-bs-toggle="tab"><span class="badge bg-secondary me-1">3</span> Valores</a></li>
            </ul>
            <div class="tab-content border border-top-0 text-secondary p-3" id="myTabContent">
              ...
              Queremos espalhar a LetsConnect pelo mundo para que as pessoas possam ter conexões mais rápidas com nossos funcionários e para que possamos nos comunicar com suas línguas nativas.
              </div>
              <div class="tab-pane fade" id="results" role="tabpanel" aria-labelledby="contact-tab">
              1. Confiabilidade – Temos maior proteção sobre seus dados, que ficam localizados em um banco de dados codificado. 2. Velocidade – acesso rápido e simples caso emergências. 3. Responsabilidade – agimos de maneira que focamos nos benefícios dos clientes 4. Diversidade – podemos te ajudar de maneiras diferentes com problemas diferentes. 5. Respeito – independentemente de sua nacionalidade ou língua nativa te ajudaremos a resolver seus problemas sem confusão nenhuma.
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="section py-3 py-lg-5 px-2 px-lg-4" id="clients">
      <div class="container-narrow">
        <div class="text-center mb-4">
          <h2 class="marker marker-center">Confiável por</h2>
        </div>
        <div class="text-center">
          <p class="mx-auto mb-3" style="max-width:800px">Administre mercados empoderados de forma colaborativa por meio de
            redes plug-and-play.</p>
        </div>
    ...
    <div class="section bg-light py-3 py-lg-5 px-2 px-lg-4" id="services">
      <div class="container-narrow">
        ...
        <div class="text-center">
          <p class="mx-auto mb-3" style="max-width:800px">Maximize rapidamente as entregas oportunas para esquemas em tempo real.
            Mantenha drasticamente os cliques para uma solução rápida e eficiente.</p>
        </div>
        <div class="row py-3">
          <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="bg-white border rounded p-3 mt-n4">
              <div class="h5 mt-3">Desenvolvimento Web</div>
              <p class="text-small">A LetsConnect é a escolha ideal para aqueles que buscam ter um website para sua empresa ou para o uso pessoal sem dor de cabeça. </p>
            </div>
          </div>
          <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="bg-white border rounded p-3 mt-n4">
              <div class="h5 mt-3">Infraestrutura/Personal computer ( PC )</div>
              <p class="text-small">Aqui na LetsConnect resolvemos qual for o seu problema desde o seu computador pessoal até os servidores da sua empresa sem qualquer problema.</p>
            </div>
          </div>
          <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="bg-white border rounded p-3 mt-n4">
              <div class="h5 mt-3">Aplicativo movel</div>
              <p class="text-small">Deseja criar uma aplicativo mobile para sua empresa, chega de enrolação, pois na LetsConnect não pensamos apenas em você, o seu cliente totalmente satisfeito.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="d-flex py-2"><i class="mr-3 fas fa-clipboard-check fa-4x fa-fw"></i>
              <div class="ms-1">
                ...
                <div class="h6">Projetos feitos</div>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-sm-6">
            <div class="d-flex py-2"><i class="mr-3 fas fa-smile fa-4x fa-fw"></i>
              <div class="ms-1">
                ...
                <div class="h6">Clientes felizes</div>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-sm-6">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="d-flex py-2"><i class="mr-3 fas fa-clock fa-4x fa-fw"></i>
              <div class="ms-1">
                ...
                <div class="h6">Horas de suporte</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="section pt-5 pb-3 py-lg-5 px-2 px-lg-4" id="team">
      <div class="container">
        <div class="text-center mb-5">
          <h2 class="marker marker-center">Conheça nossa equipe</h2>
        </div>
      </div>
      <div class="carousel carousel-dark slide pb-3" id="" data-bs-ride="l" data-aos="zoom-in-up">
        <div class="container-narrow">
          <ol class="carousel-indicators">
            <li class="desactivate" data-bs-target="#carouselTeam" data-bs-slide-to="0" aria-label="Slide 1"></li>
          </ol>
                ...
                <div class="col-md-4">
                  <div class="card d-block mb-3"><img class="card-img-top" src="images/team/emp-1.jpg" alt="image" />
                    <div class="card-body text-center">
                      <div class="h5 mb-1">Vitor Bueno</div>
                      <div class="text-muted mb-1">CEO</div>
                      <div class="nav text-light justify-content-center"><a class="nav-link" href="#!" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a><a class="nav-link" href="#!" title="LinkedIn"><i class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a></div>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="card d-block mb-3"><img class="card-img-top" src="images/team/emp-2.jpg" alt="image" />
                    <div class="card-body text-center">
                      <div class="h5 mb-1">Guilherme Octavio</div>
                      <div class="text-muted mb-1">Desenvolvedor</div>
                      <div class="nav text-light justify-content-center"></a><a class="nav-link" href="#!" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a><a class="nav-link" href="#!" title="LinkedIn"><i class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a></div>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="card d-block mb-3"><img class="card-img-top" src="images/team/emp-3.jpg" alt="image" />
                    <div class="card-body text-center">
                      <div class="h5 mb-1">Mike Alves</div>
                      <div class="text-muted mb-1">Administração</div>
                      <div class="nav text-light justify-content-center"><a class="nav-link" href="#!" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a><a class="nav-link" href="#!" title="LinkedIn"><i class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a></div>
                    </div>
                  </div>
                </div>
    ...
    <div class="section py-3 py-lg-5 px-2 px-lg-4" id="parceria">
      <div class="container">
        <div class="text-center mb-5">
          <h2 class="marker marker-center">Parcerias </h2>
        </div>
    ...
    <div class="section py-3 py-lg-5 px-2 px-lg-4" id="testimonials">
      <div class="container-narrow">
        <div class="text-center mb-5">
          <h2 class="marker marker-center">Comentarios</h2>
        </div>
        <div class="row">
          <div class="col-md-6 mb-5" data-aos="fade-right" data-aos-delay="100">
            <div class="d-flex ms-md-3"><span><i class="fas fa-2x fa-quote-left"></i></span><span class="m-2">Adorei toda a equipe, muito bacana, show de bola. A LetsConnect sempre atende bem seus cliente, site bem moderno e pratico. Toda minha experiencia com essa empresa foi maravilhosa.</span></div>
            <div class="d-flex justify-content-end align-items-end">
              <div class="text-end me-2">
                <div class="fw-bolder">Pablo</div>
                <div class="text-small">CEO</div>
          ...
          <div class="col-md-6 mb-5" data-aos="fade-left" data-aos-delay="300">
            <div class="d-flex ms-md-3"><span><i class="fas fa-2x fa-quote-left"></i></span><span class="m-2">Estou muito feliz com o meu website, equipe atenciosa, prática e estratégica com a cativação do cliente.</span></div>
            <div class="d-flex justify-content-end align-items-end">
              <div class="text-end me-2">
                <div class="fw-bolder">Leonardo</div>
                <div class="text-small">CEO / Designer</div>
    ...
    <div class="section py-3 py-lg-5 px-2 px-lg-4" id="contact">
      <div class="container-narrow">
        <div class="text-center mb-5">
          <h2 class="marker marker-center">Faça seu cadastro</h2>
        </div>
        <div class="row">
          ...
          <div class="col-md-6" data-aos="fade-left" data-aos-delay="300">
            <div class="mt-5 px-2">
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder">letsconnect@company.com</div>
                </div>
                <div class="col-sm-2">
                  <div class="pb-1">Skype:</div>
                </div>
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder">letsconnect@skype.com</div>
                </div>
                <div class="col-sm-2">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-12 mb-3">
            ...
            <div class="text-small text-muted">
              <div class="mb-1">&copy; Copyright <strong>LetsConnect</strong>. All rights reserved.</div>
            </div>
          </div>
          ...
          <div class="col-lg-2 col-md-6 mb-3">
            ...
            <div class="text-small">
              ...
              <div class="mb-1"><strong>Email:</strong><br />letsconnect@company.com</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <style>
    :root {
      ...
      --df-messenger-font-color: rgba(7, 254, 3, 0.87);
  ...
  <df-messenger chat-icon="https://cdn.discordapp.com/attachments/749722346130112513/1039948129199476776/1da037a1-6faf-4adc-8e00-4dbe2f26700a.jpg" intent="WELCOME" chat-title="Let&#x27;s_Connect_Bot" agent-id="21da63d7-1034-4703-ae71-e22a44e51922" language-code="pt-br"></df-messenger>
  <!-- Bot -->
</body>
